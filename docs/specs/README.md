...
>
> 当前候选：0.4.7 Preview 1 / Build 1（内部 20），准备 GitHub Pre-release；不加入 appcast
...
| Spec ID | 文档 | 状态 | 当前结论 |
|---|---|---|---|
| `QV-PRODUCT-PROXY-017` | [0.4.7 自定义代理](../design/quotaview-proxy-settings-0.4.7.md) | `Accepted / Verifying` | 186 项测试、真实 CLI 代理 HTTPS 模拟和 Universal 通过；等待用户视觉/交互与真实代理环境验收；已授权仅 GitHub Preview 发布 |
