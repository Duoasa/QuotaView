...
<p align="center">
  <a href="https://github.com/Duoasa/QuotaView/releases/tag/v0.3.1-build.2"><img alt="Latest release" src="https://img.shields.io/github/v/release/Duoasa/QuotaView?display_name=tag&sort=semver"></a>
...
<p align="center">
  <a href="https://github.com/Duoasa/QuotaView/releases/download/v0.3.1-build.2/QuotaView-v0.3.1-build.2.zip"><strong>Download QuotaView 0.3.1 Build 2</strong></a>
  ·
...
2. Download `QuotaView-v0.3.1-build.2.zip` from the [0.3.1 Build 2 release](https://github.com/Duoasa/QuotaView/releases/tag/v0.3.1-build.2).
