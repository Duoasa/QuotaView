...
QuotaView 0.4.3 polishes the Progress Bar introduced in 0.4.2.

<p align="center">
  <img src="Resources/QuotaView-0.4.2-Progress-Mode.jpg" alt="QuotaView Progress Bar Codex Island product overview" width="49%">
  <img src="Resources/QuotaView-0.4.2-Progress-Styles.jpg" alt="QuotaView progress styles" width="49%">
</p>

- **Quantum Noise** now changes state colors without vertical motion, with
  clearer context-compaction feedback, denser twinkles, and a brighter finish.
- Opaque soft-gray task and status text improves readability while preserving
  the operation shimmer.
- The completion outline and breathing halo now share one consistent green.
